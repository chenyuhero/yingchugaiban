...
require_once(dirname(__FILE__)."/../include/common.inc.php");
    ...
    $q = "select * from dede_project where gpassword='".$ggpk."' AND aid='".$aid."'"; //SQL查询语句
...
elseif($arc->Fields["typeid"]>0)
{
	
		$msgtitle = "您没有权限浏览文档：{$arctitle} ！<br />";
